...
export const paymentSessionExpiresMs = 15 * 60 * 1000;
export const paymentSessionTaskIntervalMs = 1500;
export const notifyTaskIntervalMs = 3000;

const tronNetworkConfigs = {
  main: {
